...
*=$3840 "SEEQZ DEFAULT DRIVER";
seeqz_def_drvr_name: // 16 byte zero terminated string
.text "driverdefault-001" // driver default will be the 8 channel relay board
     //01234567890123456
.byte 0
seeqz_def_drvr_num_bits: // number of bits
.byte 8
seeqz_def_drvr_invert: // yes / no (invert bits going out)
.byte 1
seeqz_def_drvr_port:
.byte SEEQZ_USER_PORT
seeqz_def_drvr_draw_bits_routine: // 256 bytes reserved for specialized driver output to user port
.fill 256,0
.byte 0
